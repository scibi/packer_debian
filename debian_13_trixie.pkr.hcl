...
#    "url=http://{{ .HTTPIP }}:{{ .HTTPPort }}/preseed.cfg ",
  ...
  boot_wait = "10s"
  http_content = {
    "/preseed_trixie_separate_var_log.cfg" = templatefile("${path.root}/http/preseed_trixie_separate_var_log.cfg", { proxy = "${var.use_github && var.proxy_url != "" ? var.proxy_url : ""}", root_password = var.root_password })
  }
  http_port_min = "8000"
  http_port_max = "8000"
